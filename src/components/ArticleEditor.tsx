                  ...
                  <div>
                    ...
                    {formData.featured_image_url ? (
                      ...
                      <div className="space-y-3">
                        <button
                          onClick={() => {
                            alert('يرجى إضافة رابط الصورة يدوياً في الحقل أعلاه');
                          }}
                          disabled={true}
                          className="w-full px-4 py-3 bg-gray-400 text-gray-600 font-medium rounded-lg transition-all duration-300 flex items-center justify-center gap-2 cursor-not-allowed"
                        >
