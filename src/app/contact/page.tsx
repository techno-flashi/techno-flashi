            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-3 bg-dark-bg border border-gray-700 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-white placeholder-gray-400"
              ...
              <div>
                ...
                <select
                  id="subject"
                  name="subject"
                  className="w-full px-4 py-3 bg-dark-bg border border-gray-700 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-white"
                  required
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={6}
                  className="w-full px-4 py-3 bg-dark-bg border border-gray-700 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-white placeholder-gray-400 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary/80 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105"
              >
                إرسال الرسالة
              </button>
            </form>
